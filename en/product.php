		...
		<div class="container">
			<div class="agileinfo_single">
				...
				<div class="w3agile_description">
					<h4>Family : <a href="family_products.php?id='.$row["family_id"].'">'.$row["fname"].'</a></h4><br/>
					<h4>Description :</h4>
					<p>'.$row["description"].'</p>
				</div>
				<div class="snipcart-item block">
				<div class="snipcart-thumb agileinfo_single_right_snipcart">
					<h4 class="m-sing">Price : '.$row["price"].' SR</h4>
				</div>
				...
				<fieldset>
					...
					<input type="number" min="1" name="quan" placeholder="Quantity" required=" " >
				...
				<fieldset>
				<textarea name="eval" placeholder="write Evaluation" rows="5" cols="40"></textarea>
				<input type="submit" name="send" value="Send Evaluation" class="button" />
				</fieldset>
			    </form></div>
           </div>';?>	
...
{
echo '
<h5 style="font-size: 30px;color: orange;text-align: center;">Recommendation</h5>
<div class="products">
		<div class="container">
