			...
			<div class="w3_footer_grids">
				...
				<div class="col-md-3 w3_footer_grid">
					...
					<ul class="info"> 
						...
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="add_product.php">Add Product</a></li>
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="edit_family.php">Edit Account</a></li>
					</ul>
				</div>';
				?>
