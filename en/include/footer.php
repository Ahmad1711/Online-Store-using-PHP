		...
		<div class="container">
			<div class="w3_footer_grids">
				...
				<div class="col-md-3 w3_footer_grid">
					<h3>Profile</h3>
					<ul class="info"> 
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="login_customer.php">Customer Login</a></li>
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="login_family.php">Family Login</a></li>
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="registered_family.php">Create Family Account</a></li>
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="registered_customer.php">Create Customer Account</a></li>
					</ul>
				</div>
