...
<div class="breadcrumbs">
    <div class="container">
        ...
        <li class="active">Rate Reports</li>
        </ol>
    </div>
</div>';
?>
...
<button id="print" onclick="PrintElem()">Report Print</button>
<script>
function PrintElem()
{
    var mywindow = window.open('', 'PRINT', 'height=400,width=600');

    mywindow.document.write('<html><head><link href="css/style.css" rel="stylesheet" type="text/css" media="all" /><title>' + document.title  + '</title>');
