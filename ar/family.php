		...
		<div class="grid_3 grid_5">
			<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
				<ul id="myTab" class="nav nav-tabs" role="tablist">
					<li role="presentation" class="active"><a href="#expeditions" id="expeditions-tab" role="tab" data-toggle="tab" aria-controls="expeditions" aria-expanded="true">منتجاتي</a></li>
					<li role="presentation"><a href="#reports" role="tab" id="reports-tab" data-toggle="tab" aria-controls="reports">المنتجات الأفضل مبيع</a></li>
				</ul>
												...
												<div class="snipcart-item block" >
													...
													<div class="snipcart-details top_brand_home_details">
														<form action="" method="post">
														 ...
														 <input type="submit" name="delete" value="حذف" class="button" />
														 <input type="submit" name="edit" value="تعديل" class="button" />
														</form>
													</div>
												</div>
											</figure>
