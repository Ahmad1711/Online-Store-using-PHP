...
echo '
<tr class="rem1">
    <td class="invert">الحالة: '.$row2["status"].'</td>
	...
	<input type="radio" name="status" value="accept"> مقبول<br>
	<input type="radio" name="status" value="not accept"> غير مقبول
	</td>
    <td class="invert">
    <textarea name="eval" value="nothing" placeholder="كتابة توضيح" rows="3" cols="20"></textarea>
    </td>
	<td class="invert">
...
echo'
<tr class="rem1">
    <td class="invert">اسم الزبون: '.$row4["fname"].'<br>تاريخ الطلبية: '.$row3["order_date"].'</td>
	<td class="invert">المجموع: '.$row3["total"].' ر.س</td>
	<td class="invert">الكلفة: '.$row3["pickup_cost"].' ر.س</td>
	<td class="invert">نوع التسليم: '.$row3["delivery_type"].'</td>
	<td class="invert">موقع التسليم: '.$row3["delivery_location"].'</td>
	<td class="invert">تاريخ التسليم: '.$row3["delivery_date"].'</td>
