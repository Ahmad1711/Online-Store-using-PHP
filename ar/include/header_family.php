...
<div class="agileits_header">
	<div class="container">
		<div class="agile-login">
			<ul>
				<li><a href="add_product.php"> اضافة منتج </a></li>
				<li><a href="edit_family.php"> تعديل حساب </a></li>
				<li><a href="mycart.php"> سلة المشتريات </a></li>
				<li><a href="request_family.php">طلبات</a></li>
				<li><a href="rate_reports.php">تقارير التقييم</a></li>
