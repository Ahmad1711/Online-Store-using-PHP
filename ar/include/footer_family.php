		...
		<div class="container">
			<div class="w3_footer_grids">
				...
				<div class="col-md-3 w3_footer_grid">
					<h3>حساب</h3>
					<ul class="info"> 
						<li><i class="fa fa-arrow-left" aria-hidden="true"></i><a href="logout.php">خروج</a></li>
						<li><i class="fa fa-arrow-left" aria-hidden="true"></i><a href="add_product.php">اضافة منتج</a></li>
						<li><i class="fa fa-arrow-left" aria-hidden="true"></i><a href="edit_family.php">تعديل حساب</a></li>
					</ul>
				</div>';
				?>
