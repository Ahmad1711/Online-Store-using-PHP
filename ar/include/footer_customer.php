			...
			<div class="w3_footer_grids">
				...
				<div class="col-md-3 w3_footer_grid">
					...
					<ul class="info"> 
						...
						<li><i class="fa fa-arrow-left" aria-hidden="true"></i><a href="mycart.php">سلة المشتريات</a></li>
						<li><i class="fa fa-arrow-left" aria-hidden="true"></i><a href="edit_customer.php">تعديل حساب</a></li>
					</ul>
				</div>
