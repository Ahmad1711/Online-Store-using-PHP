...
<div class="register">
	<div class="container">
		<h2>تعديل حساب زبون</h2>
		<div class="login-form-grids">
			<h6>معلومات الحساب</h6>
			<form action="" method="post">
				<input type="text" name="fn" pattern="[A-Z _a-zأ-ي]+" title="only characters" value="'.$row["fname"].'" required=" " >
                <input type="text" name="ln" pattern="[A-Z _a-zأ-ي]+" title="only characters" value="'.$row["lname"].'" required=" " >
